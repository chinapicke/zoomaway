      ...
      <nav className="bg-white p-3">
        <div className="flex flex-wrap justify-between mx-auto ">
          ...
          <div className="flex items-center lg:order-2">
            <a href="https://www.facebook.com/" className=" focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-lg px-4 lg:px-5 py-2 lg:py-2.5 mr-2 ">Sign up</a>
            <a href="https://www.facebook.com/" className=" focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-lg px-4 lg:px-5 py-2 lg:py-2.5 mr-2 da">Register</a>
          </div>
