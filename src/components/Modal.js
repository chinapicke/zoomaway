...
function Modal({ open, onClose }) {
    ...
    if (!open) return null;
    return (
        <div className=" modalPopup overflow-auto w-full fixed inset-0 outline-none focus:outline-none bg-gray-900 bg-opacity-50"
            onClick={onClose}>
            <div className=" modalInner relative w-auto my-3 mx-auto max-w-3xl"
                onClick={(e) => e.stopPropagation()}>
                <div className="modalTemplate border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                    ...
                    <div className=" modalContent overflow-auto relative p-6 flex-auto">{
                        newList.map((data) =>
                            <>
                    ...
                    <form ref={form}>
                        <div className="modalForm overflow-auto grid md:grid-cols-2 sm:gap-5">
                            <div className=" fNameInput w-full pr-8 mb-2 group">
                        ...
                        <div className="emailInput w-full pr-8 group">
                        <label>Email:</label>
                            <input type="email"
                        ...
                        {/* <div className="ageEmailModal mb-2 grid md:grid-cols-2 md:gap-6">
                            ...
                            <label className='break-words'>Phone:</label>
                                <input type="tel"
                                    className=' ml-2 bg-gray-300 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500  w-64 p-1 text-center'
                                    value={telephone}
                                    onChange={telephoneEnter}
                                    name='phone_number'
                                />
